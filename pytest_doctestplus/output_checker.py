...
class OutputChecker(doctest.OutputChecker):
    ...
    def partial_match(self, arr, chunks):
        ...
        >>> OutputChecker().partial_match(['1', '2', '3', '4'],
        ...                               [['1', '2'], ['4']])
        True
        >>> OutputChecker().partial_match(['1', '2', '3', '4'],
        ...                               [['1', '2'], []])
    ...
    def normalize_floats(self, want, got, flags):
        ...
        if not (flags & doctest.DONT_ACCEPT_BLANKLINE):
            ...
            pattern = r'(?m)^{}\s*?$'.format(re.escape(doctest.BLANKLINE_MARKER))
            want = re.sub(pattern, '', want)
        ...
        numbers_want_chunks = [self.find_numbers(chunk)
